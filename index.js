...
server.post("/ec021/toddy", function (req, res) {
    ...
    let resposta = {
        id: "1", //Simulando a resposta do BD
        lote,
        conteudo,
        validade,
    };
...
// PATCH ou PUT => Updates => http://localhost:5000/ec021/toddy/:id (id = path parameter)
...
// GET => Reads => http://localhost:5000/ec021/toddy/?id=xyz (id = query paramete)
